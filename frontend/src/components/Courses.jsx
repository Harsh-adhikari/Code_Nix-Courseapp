      ...
      >
        ...
        <nav>
          <ul>
            ...
            <li className="mb-4">
              <a href="#" className="flex items-center text-violet-600">
      ...
      <main className="ml-0 md:ml-64 w-full bg-white p-10">
        <header className="flex justify-between items-center mb-10">
          ...
          <div className="flex items-center space-x-3">
            ...
            <FaCircleUser className="text-4xl text-violet-600" />
          </div>
        </header>
              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="bg-violet-600 w-full text-white px-4 py-2 rounded-lg hover:bg-blue-900 duration-300"
                  >
                    Buy Now
                  </Link>
                </div>
